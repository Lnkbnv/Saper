...
namespace Saper
{
    public partial class Form1 : Form
    {
        ...
        private void BOOM(int x, int y)
        {
            ...
            MessageBox.Show("Вы подорвались", "БАБАХ!!!");
    ...
    Версия: 2.0
    Автор: Кабанова Алина и Салтыкова Вероника
    Создана: 10.04.2022 под покровом ночи
    Программа предоставляется на правах ""as is"".
", "О программе");
        }
